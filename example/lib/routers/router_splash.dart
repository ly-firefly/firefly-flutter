...
class _SplashRouterState extends State<SplashRouter> {
  ...
  _loadSplash() async {
    ...
    FFSplashManager.loadSplash(adSlotId: slotId, priceFloor: priceFloorH).then((
        value) {
  ...
  Future<bool> _isAdReady() async {
    bool isAdReady = await FFSplashManager.isAdReady();
  ...
  _getAdSlotAd() async {
    FFSplashManager.getAdSlotAd().then((value) {
      print("代码位Id = ${value}");
  ...
  _getRequestId() async {
    FFSplashManager.getRequestId().then((value) {
  ...
  _getEcpm() async {
    FFSplashManager.getEcpm().then((value) {
      print("ecpm = ${value}");
  ...
  _getMaterialType() {
    FFSplashManager.getMaterialType().then((value) {
      print("物料类型 = ${value}");
  ...
  _win() {
    ...
    FFSplashManager.win(price: price, map: map);
  }
  ...
  _loss() {
    ...
    FFSplashManager.loss(price: price, map: map);
  }
